          ...
          {!showHumor ? (
            ...
            >
              ...
              <motion.div
                ...
                className="text-center"
              >
                <div className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl bg-gradient-to-r from-[#FFD700] via-[#C8AA6E] to-[#0AC8B9] bg-clip-text text-transparent tabular-nums mb-2" style={{ fontFamily: 'Georgia, serif', paddingBottom: '8px' }}>
                  {kda.toFixed(1)}
                </div>
