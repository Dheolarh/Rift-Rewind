        ...
        <AnimatePresence mode="wait">
          {!showHumor ? (
            ...
            <motion.div
              ...
              className="size-full flex flex-col items-center w-full"
            >
              ...
              >
                ...
                <div className="text-6xl sm:text-7xl md:text-8xl lg:text-9xl leading-none bg-gradient-to-br from-[#8B5CF6] via-[#A78BFA] to-[#C4B5FD] bg-clip-text text-transparent tabular-nums mb-2 sm:mb-3" style={{ fontFamily: 'Georgia, serif', paddingBottom: '8px' }}>
